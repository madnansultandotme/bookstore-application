                        ...
                        <?php if(auth()->user()->isAdmin()): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.users.index')); ?>">Manage Users</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.orders.index')); ?>">Manage Orders</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <li class="nav-item">
