            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex">
                    <div class="shrink-0 flex items-center">
                        <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold text-primary flex items-center gap-2 hover:opacity-90 transition">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('cart.index')); ?>" class="text-gray-500 hover:text-primary p-2 relative transition group mr-3 cart-icon">
                            ...
                            <?php if($cartItemsCount > 0): ?>
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center animate-pulse">
                                    <?php echo e($cartItemsCount > 9 ? '9+' : $cartItemsCount); ?>
                        ...
                        <div class="ml-3 relative" x-data="{ dropdownOpen: false }">
                            ...
                            <div x-show="dropdownOpen" 
                                ...
                                <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition" role="menuitem" tabindex="-1">My Orders</a>
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <div class="border-t border-gray-100 my-1"></div>
                                    <span class="block px-4 py-1 text-xs text-gray-400 font-semibold uppercase tracking-wider">Admin</span>
                                    <a href="<?php echo e(route('admin.books.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Manage Books</a>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Manage Users</a>
                                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">Manage Orders</a>
                                <?php endif; ?>
                                <div class="border-t border-gray-100 my-1"></div>
                    ...
                    <?php else: ?>
                        <div class="flex space-x-4">
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-500 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition">Log in</a>
                            <a href="<?php echo e(route('register')); ?>" class="bg-primary text-white hover:bg-indigo-700 px-4 py-2 rounded-md text-sm font-medium shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5">Register</a>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center px-4">
                        ...
                        <a href="<?php echo e(route('cart.index')); ?>" class="ml-auto flex-shrink-0 bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary relative">
                    ...
                    <div class="mt-3 space-y-1">
                        <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">My Orders</a>
                        <?php if(auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.books.index')); ?>" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Manage Books</a>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Manage Users</a>
                            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Manage Orders</a>
                        <?php endif; ?>
                         <form action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="mt-3 space-y-1">
                        <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Log in</a>
    ...
    <footer class="bg-gray-900 text-gray-300 text-center py-8 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 pt-8 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Online Bookstore')); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\adnan\Downloads\bookstore-application\resources\views/layouts/app.blade.php ENDPATH**/ ?>