            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('cart.index')); ?>" class="text-gray-500 hover:text-primary p-2 relative transition group">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center px-4">
                        ...
                        <a href="<?php echo e(route('cart.index')); ?>" class="ml-auto flex-shrink-0 bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
